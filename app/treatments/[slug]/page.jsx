...
export default function TreatmentDetailPage({ params }) {
  ...
  return (
    <div className="sharp-theme min-h-screen bg-[#111111] text-[#12332f]">
      ...
      <main className="mx-auto -mt-8 max-w-5xl space-y-7 px-5 pb-14 md:px-6">
        ...
        <section className="rounded-[26px] bg-white p-6 shadow-[0_20px_40px_rgba(7,45,41,0.1)] md:p-9">
          <h2 className="text-3xl font-black text-[#0b355f]">Tedavi Özeti</h2>
          <p className="mt-4 leading-8 text-[#35514d]">{treatment.overview}</p>

          <h3 className="mt-8 text-2xl font-black text-[#0c4f49]">Bu tedavide neler var?</h3>
          ...
          <div className="mt-8 rounded-2xl bg-[#0fa79b] p-6 text-white">
            <h3 className="text-2xl font-black">Tahmini Tedavi Süresi: {treatment.duration}</h3>
            <p className="mt-2 text-white/90">Kişisel muayene sonrası kesin plan ve süre doktorunuz tarafından netleştirilir.</p>
