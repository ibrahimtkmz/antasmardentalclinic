...
const collageItems = [
  {
    ...
    alt: 'Smiling patient',
    className:
      'absolute left-6 top-6 h-[95px] w-[150px] rotate-[-15deg] [clip-path:polygon(12%_0,100%_5%,78%_100%,0_86%)]',
  },
  {
    src: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=900&q=80',
    alt: 'Patient portrait',
    className:
      'absolute left-[155px] top-8 h-[112px] w-[118px] rotate-[7deg] [clip-path:polygon(8%_0,100%_0,87%_100%,0_93%)]',
  },
  {
    src: 'https://images.unsplash.com/photo-1609840112855-9a32a5fba00f?auto=format&fit=crop&w=900&q=80',
    alt: 'Dental treatment',
    className:
      'absolute right-5 top-[34px] h-[95px] w-[157px] rotate-[-10deg] [clip-path:polygon(0_12%,88%_0,100%_74%,12%_100%)]',
  },
  {
    src: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=900&q=80',
    alt: 'Laser whitening',
    className:
      'absolute left-4 top-[115px] h-[170px] w-[190px] rotate-[7deg] [clip-path:polygon(3%_16%,100%_0,80%_100%,0_84%)]',
  },
  {
    src: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=900&q=80',
    alt: 'Happy smile',
    className:
      'absolute left-[128px] top-[150px] h-[260px] w-[245px] rotate-[7deg] [clip-path:polygon(18%_0,100%_16%,58%_100%,0_86%)]',
  },
  {
    src: 'https://images.unsplash.com/photo-1588774069410-84ae30757c8e?auto=format&fit=crop&w=900&q=80',
    alt: 'Dental care close-up',
    className:
      'absolute right-[12px] top-[202px] h-[210px] w-[145px] rotate-[-7deg] [clip-path:polygon(6%_8%,100%_0,83%_100%,0_88%)]',
  },
];
...
export default function Footer() {
  ...
  <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 lg:py-20">
    <div className="grid gap-10 lg:grid-cols-[1.5fr_0.8fr_1fr_1fr] items-start">
      ...
      <div className="relative"> {/* Konteynırı göreceli yaptık */}
        <div className="inline-flex items-center">
          <img
            src="/logo-beyaz.png"
            alt="Anastamar Dental Clinic Logo"
            /* - m-0 ve p-0 ile tüm boşlukları sıfırladık.
               - translate-x-[-10%] ile logoyu hafif sola kaydırarak 
                 yandaki metinlere yer açabilirsin.
            */
            className="h-[350px] w-auto object-contain sm:h-[450px] m-0 p-0 block -ml-10 -mt-10"
          />
        </div>
        {/* Logonun altına gelen metin varsa aşağıda kalmaya devam eder */}
      </div>
          ...
          <div className="relative min-h-[430px] overflow-hidden rounded-[24px] bg-[#010f1f] p-2">
            ...
            <div className="relative h-full w-full">
              {collageItems.map((item) => (
                <img key={item.alt} src={item.src} alt={item.alt} className={`${item.className} object-cover`} />
              ))}
