...
export default function Header() {
  ...
  return (
    <header
  className="-ml-[20px] page-shell sticky top-0 z-50 mt-0 bg-transparent pt-[50px] transition-colors md:pt-[15px] md:rounded-[0_0_26px_26px] md:border md:border-[#d9ecea] md:bg-[#f7fffe] md:shadow-[0_10px_24px_rgba(8,41,38,0.1)]"
>
      <div className="flex items-center justify-between gap-3 px-4 py-1.5 md:gap-6 md:px-8 md:py-2">
        ...
        <nav className="hidden flex-1 items-center justify-center gap-x-6 whitespace-nowrap text-[11px] font-bold uppercase tracking-[0.1em] text-[#1a4743] md:flex">
        ...
        <div className="ml-auto -mt-1 flex items-center gap-1 md:hidden">
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center text-[#1a4743]"
          >
